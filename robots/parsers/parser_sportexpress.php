    ...
    public static function get_comments($line)
    {
        ...
        do {
            ...
            if ($num == 1) {
                ...
                $url = $line['url'] . 'page' . $num . '/#comment_form';
            }
        ...
        for ($i = 0; $i < count($blockcomm); $i++) {
            ...
            if (strpos($blockcomm [$i], 'class="mt_20') !== false) {
                ...
                do {
                    ...
                    $j++;
                    if (strpos($blockcomm [$i + $j], 'fs_13 uppercase mt_10') !== false) {
                        $flag = 1;
                    };
                } while ($flag == 0);
            ...
            if (strpos($blockcomm [$i], 'fs_13 uppercase mt_10') !== false) {
                ...
                $comm [$k]['time'] = self::patch_time(mb_substr($comm [$k]['time'], 12));
                $comm [$k]['url'] = $line['url'];
